<template>
    <section class="section-tours" id="section-tours">
                    ...
                    <div class="col-1-of-3">
                        <div class="card">
                            <div class="card__side card__side--front">
                                ...
                                <div class="card__deatails">
                                    <ul>
                                        <li>3 day tore</li>
                                        <li>up tp 30 peaople</li>
                                        <li>2 toure guides</li>
                            ...
                            <div class="card__side card__side--back card__side--back-1">
                                <div class="card__cta">
                                    <div class="card__price-box">
                                        ...
                                        <p class="card__price-value">$296</p>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card__side card__side--front">
                                ...
                                <div class="card__deatails">
                                    <ul>
                                        <li>7 day tore</li>
                                        <li>up tp 40 peaople</li>
                                        <li>6 toure guides</li>
                                        <li>sleep in cozy hotels</li>
                            ...
                            <div class="card__side card__side--back card__side--back-2">
                                ...
                                <div class="card__price-box">
                                            <p class="card__price-only">Only</p>
                                            <p class="card__price-value">$476</p>
                                        </div>
                                        <a href="#popup" class="btn btn--white">Book now!</a>   
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card__side card__side--front">
                                ...
                                <div class="card__deatails">
                                    <ul>
                                        <li>5 day tore</li>
                                        <li>up tp 15 peaople</li>
                                        <li>3 toure guides</li>
                                        <li>sleep in cozy hotels</li>
                ...
                <div class="u-center-text u-margin-top-huge">
                    <a href="#" class="btn btn--green">Discover all tors</a>
                </div>
            </section>
</template>
<style lang="scss">
.section-tours {
    ...
    &__side {
        ...
        &--back {
            ...
            &-1 {
                background-image: linear-gradient(to right bottom, $color-secondary-ligth, $color-secondary-dark);
            }
            ...
            &-3 {
                background-image: linear-gradient(to right bottom, $color-tertiary-ligth, $color-tertiary-dark);
            }
        }
    }
